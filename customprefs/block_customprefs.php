...
function get_content() {
       ...
       $this->content->text .= html_writer::end_tag('form');
        $this->content->text .= html_writer::end_tag('div');
       //script to display block with form course selection => should be in amd folder
        $this->content->text .="<script>
                                            let togg0 = document.getElementById('customprefs_optionselectopener'); 
                                            let togg1 = document.getElementById('customprefs_courseselectopener'); 
                                            let d0=document.getElementById('customprefs_optionselectblock');
                                            let d1=document.getElementById('customprefs_courseselectblock');
